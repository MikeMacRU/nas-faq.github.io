...
**NB** **Alex Tutubalin** Если вы заливали данных в деградированный пул (4 диска, двух не хватает - в моем случае), то после восстановления избыточности - чтение этих залитых данных будет происходить с тех самых четырех исходных, уже без ротации по кругу. В общем, еще два дня подвигал терабайты, обогатился новым знанием: не надо собирать деградированные массивы. [Исходный пост](http://forum.ixbt.com/topic.cgi?id=109:256:1969#1969)
